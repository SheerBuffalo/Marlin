...
#define STRING_CONFIG_H_AUTHOR "SheerBuffalo/Michi Maker" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CNC Root2"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.9, 177.78, 1100 }
